...
class TurnPipeline:
    ...
    def _build_prompts(
        ...
        user_prompt = (
            ...
            "During normal conversation, do not keep steering the topic back to quests or tasks. "
            "If the player wants small talk, local gossip, personal questions, or casual conversation, follow that topic naturally as this NPC would. "
            "Only make quests/tasks the main topic when the player asks about them, asks for work, asks what to do next, or when a quest update is genuinely necessary. "
