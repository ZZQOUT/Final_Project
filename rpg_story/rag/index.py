...
from rpg_story.rag.chunking import ChunkConfig, chunk_documents
...
class RAGIndex:
    def __init__(
        ...
        *,
        ...
        self.store = store
        self.chunk_cfg = ChunkConfig(
            max_chars=max(120, int(chunk_size_chars)),
    ...
    def upsert(self, docs: List[Document]) -> None:
        ...
        chunked = chunk_documents(deduped, self.chunk_cfg)
        self.store.add(dedupe_docs(chunked))
